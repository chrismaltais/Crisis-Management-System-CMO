...
<html>
	...
	<section class="content-header">
		<h1>
			General UI <small>Preview of UI elements</small>
		</h1>
		<ol class="breadcrumb">
				...
				<div class="box box-danger">
					...
					<div class="box-body">
						<div class="alert alert-danger alert-dismissable">
							...
							<b>Alert!</b> Danger alert preview. This alert is dismissable. A
				...
				<div class="box box-info">
					...
					<div class="box-body">
						<div class="callout callout-danger">
							...
							<p>There is a problem that we need to fix. A wonderful
					...
					<ul class="nav nav-tabs">
						...
						<li class="dropdown"><a class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								<li role="presentation"><a role="menuitem" tab/="-1"
									href="#">Action</a></li>
								<li role="presentation"><a role="menuitem" tab/="-1"
			...
			<div class="col-md-6">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs pull-right">
						<li class="active"><a href="#tab_1-1" data-toggle="tab">Tab
								1</a></li>
					...
					<div class="tab-content">
						...
						<!-- /.tab-pane -->
						<div class="tab-pane" id="tab_2-2">The European languages
							...
							several languages coalesce, the grammar of the resulting language
						...
						<div class="box-group" id="accordion">
							...
							<div class="panel box box-danger">
								<div class="box-header">
									<h4 class="box-title">
										<a data-toggle="collapse" data-parent="#accordion"
											href="#collapseTwo"> Collapsible Group Danger </a>
									</h4>
								</div>
							...
							<div class="panel box box-success">
								<div class="box-header">
									<h4 class="box-title">
										<a data-toggle="collapse" data-parent="#accordion"
											href="#collapseThree"> Collapsible Group Success </a>
									</h4>
								</div>
			...
			<div class="col-md-6">
				<div class="box box-solid">
					...
					<div class="box-body">
						...
						<p class="text-light-blue">Text light blue to emphasize info
							(2)</p>
